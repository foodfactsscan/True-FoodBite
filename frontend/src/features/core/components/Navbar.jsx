                ...
                <Link to="/" style={{
                    ...
                    <style>{`
                        ...
                        @keyframes premiumBreathe {
                            0%, 100% { transform: scale(0.95) translateZ(0); opacity: 0.3; }
                    ...
                    {/* Highly Refined Animated Typography */}
                    ...
                    {isAuthenticated ? (
                        <div style={{ position: 'relative' }}>
                            <button onClick={() => setShowUserMenu(!showUserMenu)} style={{
                                ...
                                color: '#f1f5f9', cursor: 'pointer', fontWeight: '800', fontSize: '0.8rem'
                            }}>
                                <User size={14} />
                        ...
                        <Link to="/login" style={{
                            padding: '0.4rem 1.5rem', color: '#000', textDecoration: 'none',
                            background: '#84cc16', borderRadius: '50px',
                            fontSize: '0.85rem', fontWeight: '800', transition: 'all 0.3s',
